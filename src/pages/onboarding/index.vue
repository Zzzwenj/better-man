...
@keyframes glitch {
  ...
  10% { text-shadow: -2px 0 #10b981, 2px 0 #ef4444; }
  20% { text-shadow: 2px 0 #10b981, -2px 0 #ef4444; }
}
...
.btn-text { color: #000; font-size: 16px; font-weight: 900; letter-spacing: 2px; text-align: center; width: 100%;}
